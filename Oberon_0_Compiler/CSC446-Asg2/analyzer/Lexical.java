...
private Token  evalSymbolToken(char symbol){
	...
	if(symbol == '>' || symbol == '<' || symbol == ':') {
		  ...
		  if((char) streamTokenizer.ttype == '='){
			  ...
			  else return new Token(TokenType.RELOP, symbol+"=" + "",symbol+"=",streamTokenizer.lineno());
			    
		  }
		  else {
			  streamTokenizer.pushBack();
			  if(symbol == ':') return new Token(TokenType.SYMBOL, symbol+"" ,symbol+"",streamTokenizer.lineno());
			  else  return new Token(TokenType.RELOP, symbol+"" ,symbol+"",streamTokenizer.lineno());
		  }
	}
	/**
	...
	*/
	...
	if(symbol == '=' || symbol == '#')
		   return new Token(TokenType.RELOP, (char) streamTokenizer.ttype + "",(char) streamTokenizer.ttype + "",streamTokenizer.lineno());
 ...
 public void backUp() {
    ...
    // System.out.println("Backed Up");
     if(pastEndOfInput) pastEndOfInput = false; // added to fix backing up EOI.
 }
