...
It conssists of three packages/folders in CSC446-ASG6.
...
b. Compile the java classes in analyzer folder : CSC446-ASG6> javac ./analyzer/*.java
c. Compile the java classes in st folder : CSC446-ASG6> javac ./st/*.java
d.Compile the java classes in parse foldr : CSC446-ASG6> javac ./parse/*.java

2. Run the Driver program  of the parse package passing one input argument i.e. the file containg the program 
  CSC446-ASG6> java parse.Driver program.obr
