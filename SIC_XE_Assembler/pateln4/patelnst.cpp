...
void SymbolTable ::insertSymbol(string symbol,SymbolAttribute &data ){
...
void SymbolTable ::viewSymbolTable()
    ...
    outflst<<setw(10)<<"symbol"<<setw(10)<<"Rflag"<<setw(10)<<"Value"<<setw(10)<<"Mflag"<<setw(10)<<"Iflag"<<endl<<endl;
...
int  SymbolTable :: calculaterflag(string rflag)
    {
...
SymbolAttribute* SymbolTable ::searchSymbol(string symbol)
    {
    SymbolAttribute* data ;
